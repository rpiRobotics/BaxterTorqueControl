...
class PControlNode:
    ...
    def _find_grav_comp_tau(self, arm='right'):
        ...
        # what follows is a lengthy output conversion from Matlab's built model G(q)
        # such that its results can be used in Python
    ...
    def _joint_state_callback(self, data):
        ...
        # If none of our joints violate the threshold, the arm isnt moving
    ...
    def _move_to_random(self):
        ...
        while time.time() - now < 4 and total_difference > .1:
            ...
            # Stop collection attempt if arm is too close to the floor or a wheel
    ...
    def spin(self):
        ...
        # run until 100 data points are collected or manually stopped
...
my_node = PControlNode('pid_auto.csv')
my_node.spin()
